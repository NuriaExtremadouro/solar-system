...
const planets = [
  {
    ...
    name: 'Mercury',
    title: 'Mercury is hot, but not too hot for ice',
    description: 'The closest planet to the Sun does indeed have ice on its surface. That sounds surprising at first glance, but the ice is found in permanently shadowed craters — those that never receive any sunlight. It is thought that perhaps comets delivered this ice to Mercury in the first place. In fact, NASA’s MESSENGER spacecraft not only found ice at the north pole, but it also found organics, which are the building blocks for life. Mercury is way too hot and airless for life as we know it, but it shows how these elements are distributed across the Solar System.'
  },
  {
    image: 'https://fotos01.laopiniondemurcia.es/mmp/2019/05/27/690x278/venus.jpg',
    name: 'Venus',
    title: 'Venus doesn’t have any moons, and we aren’t sure why',
    description: 'Both Mercury and Venus have no moons, which can be considered a surprise given there are dozens of other ones around the Solar System. Saturn has over 60, for example. And some moons are little more than captured asteroids, which may have been what happened with Mars’ two moons, for example. So what makes these planets different? No one is really sure why Venus doesn’t, but there is at least one stream of research that suggests it could have had one in the past.'
  },
  {
    image: 'https://c4.wallpaperflare.com/wallpaper/76/37/298/space-3d-digital-art-planet-wallpaper-preview.jpg',
    name: 'Earth',
    title: 'You can see Earth’s magnetic field at work during light shows',
  ...
  return (
    <>
      <Grid container xs={12}>
        ...
        <Grid xs={12} sm={6}>
          {planets.map(planet => <Card data={planet} />)}
        </Grid>
        <Hidden xsDown>
          <Grid xs={1} sm={3} />
        </Hidden>
